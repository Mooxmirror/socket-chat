...
function init() {
	socket.on('message', function(obj) {
		var entry = $('<div>', { class: 'chat-entry' });
		entry.addClass('message');

		var channel = $('<span>', { class: 'chat-message-channel' });
		var source = $('<span>', { class: 'chat-message-source' });
		var content = $('<span>', { class: 'chat-message-content' });
	...
	socket.on('err', function(obj) {
		var entry = $('<div>', { class: 'chat-entry error-message' });

		var channel = $('<span>', { class: 'chat-message-channel chat-message-wide' });
		var content = $('<span>', { class: 'chat-message-content' });
	...
	socket.on('status', function(obj) {
		var entry = $('<div>', { class: 'chat-entry status-message' });
